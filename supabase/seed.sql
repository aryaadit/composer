...
ALTER TABLE composer_venues ENABLE ROW LEVEL SECURITY;

-- Allow public read access
CREATE POLICY "Public read access" ON composer_venues
  FOR SELECT USING (true);

-- Seed: 5 curated venues across different neighborhoods, roles, and tiers

INSERT INTO composer_venues (name, category, neighborhood, address, latitude, longitude, stop_roles, price_tier, vibe_tags, occasion_tags, outdoor_seating, reservation_url, curation_note, quality_score, curation_boost, best_after) VALUES
...
('Jack''s Wife Freda', 'American', 'soho-nolita', '345 Broadway, New York, NY 10013', 40.7243, -74.0019,
 ARRAY['main'], 2,
